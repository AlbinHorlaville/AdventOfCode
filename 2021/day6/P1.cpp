...
unordered_map<int, int> getInput(const char *filename)
{
...
int main()
{
    unordered_map<int, int> lanternfishs = getInput("2021/day6/input.txt");

    for (int day=0; day < 80; day++)
    {
        int new_lanternfishs = lanternfishs[0]; // Sauvegarde du nombre de lanternfish qui s'apprètent à accoucher
